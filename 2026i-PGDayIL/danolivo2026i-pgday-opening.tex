...
% \lever{number}{name}{metrics}
\newcommand{\lever}[3]{%
  \begin{tcolorbox}[enhanced, arc=3pt, colback=paper, colframe=mailrule,
    boxrule=0.4pt, left=8pt, right=8pt, top=5pt, bottom=5pt,
    before skip=0pt, after skip=5pt]
  \makebox[0.9cm][l]{\Large\bfseries\textcolor{ptoaccent}{#1}}%
  {\large\color{ptoink}#2}%
  \hfill{\ttfamily\scriptsize\textcolor{black!45}{#3}}
  \end{tcolorbox}}

\begin{frame}\frametitle{Levers on a query plan}
\vspace*{\fill}

\lever{1}{Estimation errors}{avg / rms / twa / wca\_error}
\lever{2}{Missing indexes}{f\_scan\_filter, f\_join\_filter}
\lever{3}{Heavy SubPlans}{f\_worst\_splan}
\lever{4}{Enough \texttt{work\_mem}?}{temp\_blks}
