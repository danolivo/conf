...
\begin{frame}[fragile]\frametitle{How the Apply Worker Inserts (Before)}
\begin{center}
\begin{tikzpicture}[
  box/.style={draw, rounded corners, minimum height=0.7cm,
...
\begin{frame}[fragile]\frametitle{Batch Inserts in the Apply Worker}
\begin{center}
\begin{tikzpicture}[
  box/.style={draw, rounded corners, minimum height=0.7cm,
              align=center, font=\scriptsize, inner sep=4pt},
...
%
\begin{frame}\frametitle{Table Eligibility --- Who Gets Batched?}
...
\begin{frame}\frametitle{Replication Catch-Up Time}
\begin{center}
\begin{tikzpicture}
\begin{axis}[
    ybar,
...
\addplot[fill=red!60] coordinates {(1M,19.9) (10M,223.0) (100M,2776.0)};
\addplot[fill=green!60] coordinates {(1M,10.5) (10M,139.2) (100M,1306.5)};
\legend{multi\_insert = off, multi\_insert = on}
\end{axis}
\end{tikzpicture}
\end{center}
\begin{center}
...
\begin{frame}\frametitle{Subscriber WAL Generated}
\begin{center}
\begin{tikzpicture}
\begin{axis}[
    ybar,
...
\addplot[fill=red!60] coordinates {(1M,186) (10M,2753) (100M,18432)};
\addplot[fill=green!60] coordinates {(1M,134) (10M,2223) (100M,13312)};
\legend{multi\_insert = off, multi\_insert = on}
\end{axis}
\end{tikzpicture}
\end{center}
\begin{center}
\textbf{19\% -- 28\% less WAL} on the subscriber. At 100M rows: 18\,GB $\to$ 13\,GB.
\end{center}
\end{frame}
...
\begin{frame}\frametitle{Challenges \& Limitations}
\begin{itemize}
...
\begin{frame}\frametitle{Future: MULTI\_INSERT Protocol Message}
\begin{center}
\begin{tikzpicture}[
  box/.style={draw, rounded corners, minimum height=0.7cm,
              align=center, font=\scriptsize, inner sep=4pt},
