...
"Check actually allocated buffers (should be approximately "2048")"
...
--------------------------------------------------------------------
 Function Scan on pg_flush_local_buffers (actual rows=1.00 loops=1)
   Buffers: local written=2024
 Planning Time: 0.009 ms
 Execution Time: 3.209 ms
(4 rows)
...
-------------------------------------------------------------------
 Function Scan on pg_temp_buffers_dirty (actual rows=1.00 loops=1)
   Buffers: local hit=2048 dirtied=2048
 Planning Time: 0.002 ms
