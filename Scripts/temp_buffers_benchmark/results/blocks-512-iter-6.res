...
"Check actually allocated buffers (should be approximately "512")"
...
-------------------------------------------------------------------
 Function Scan on pg_temp_buffers_dirty (actual rows=1.00 loops=1)
   Buffers: local hit=512 dirtied=512
 Planning Time: 0.002 ms
