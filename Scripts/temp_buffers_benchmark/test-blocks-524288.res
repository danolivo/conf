CREATE EXTENSION
SET
temp_buffers= 524288, ntuples= 524288*7
"Prepare table"
CREATE TABLE
INSERT 0 3670016
...
-------------------------------------------------------------------
 Function Scan on pg_read_temp_relation (actual rows=1.00 loops=1)
   Buffers: local hit=323 read=523965
 Planning Time: 0.028 ms
 Execution Time: 3382.252 ms
(4 rows)

                            QUERY PLAN                             
-------------------------------------------------------------------
 Function Scan on pg_read_temp_relation (actual rows=1.00 loops=1)
   Buffers: local hit=524288
 Planning Time: 0.060 ms
 Execution Time: 128.594 ms
(4 rows)
