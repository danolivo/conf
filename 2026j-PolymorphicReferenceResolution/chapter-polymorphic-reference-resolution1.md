...
reaching several orders of magnitude even on well-analysed tables. The polymorphic resolution pattern, with its N outer
joins, is exposed to this compounding.
...
The rewrite is a common practitioner workaround and has theoretical support
in the partitioned-evaluation literature.
...
structural invariants within a single base-table scan.
